...
function updateBookmark(hikeDocID) {
    // alert("inside update bookmark"); // Debug alert
    currentUser.get().then(doc => {
        ...
        if (currentBookmarks && currentBookmarks.includes(hikeDocID)) {
            ...
            .then(function() {
                ...
                let iconID = "save-" + hikeDocID;
                console.log(iconID);
                document.getElementById(iconID).innerText = "bookmark_border"; // Change icon to unfilled
            });
        } else {
            currentUser.update({ // Corrected from `set` to `update`
                bookmarks: firebase.firestore.FieldValue.arrayUnion(hikeDocID)
            },
            {
            ...
            .then(function() {
                ...
                let iconID = "save-" + hikeDocID;
                console.log(iconID);
                document.getElementById(iconID).innerText = "bookmark"; // Change icon to filled
            });
        }
    });
}
